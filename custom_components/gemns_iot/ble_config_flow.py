...
class GemnsBluetoothConfigFlow(ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_user(
        ...
        if user_input is not None:
            ...
            device_type = int(user_input.get(CONF_DEVICE_TYPE, "4"))  # Convert string to int, default to leak detector
    ...
    async def async_step_user_config(
        ...
        if user_input is None:
            ...
            descriptions = {
                "leak_detector": "Configure your Gemns™ IoT Leak Detector. This device detects water leaks and moisture.",
        ...
        device_type_map = {
            ...
            "two_way_switch": 3,
            "leak_detector": 4,
            "unknown": 4  # Default to leak detector
        }
        ...
        try:
            ...
            if "Gemns" in device_name:
                ...
                if "Leak" in device_name or "leak" in device_name:
                    return "leak_detector", "Gemns™ IoT Leak Detector"
